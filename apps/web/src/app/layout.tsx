...
const themeInit = `(function(){try{var m=localStorage.getItem('optifi_mode');if(m!=='dark')m='light';var a=localStorage.getItem('optifi_accent');if(['brand','amber','violet','emerald'].indexOf(a)<0)a='emerald';var r=document.documentElement;r.setAttribute('data-mode',m);r.setAttribute('data-accent',a);}catch(e){}})();`;
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang={lang === 'pt' ? 'pt-PT' : 'en'} data-mode="light" data-accent="emerald" suppressHydrationWarning>
      <head>
